...
StereoCamera::StereoCamera(const StereoCamera &other)
	: eye_position_(other.eye_position_),
	  lookat_(other.lookat_),
	  up_(other.up_),
	  distance_(other.distance_),
	  vp_width_(other.vp_width_),
	  vp_height_(other.vp_height_),
	  left_camera_(other.left_camera_),
	  right_camera_(other.right_camera_),
	  x_(other.x_) {}
...
void StereoCamera::render_highlights(
	GraphSettings &graph_settings, VolumeSettings &volume_settings, std::string image) {

#include "PerlinModifierDecorator.hpp"
...
PerlinModifierDecorator::PerlinModifierDecorator(PointModifier *basic_modifier,
	picojson::value::object &settings_obj, RaySettings ray_settings, 
	VolumeSettings volume_settings)
: basic_modifier_(basic_modifier), ray_settings_(ray_settings),
volume_settings_(volume_settings) {
	...
	perlin_volume_ = new CCLattice(Vector(0, 0, 0), Vector(1, 1, 1),
		Vector(256, 256, 256), interpolator);
...
PerlinModifierDecorator::PerlinModifierDecorator(
	const PerlinModifierDecorator &other)
: basic_modifier_(other.basic_modifier_), perlin_volume_(other.perlin_volume_), 
ray_settings_(other.ray_settings_), volume_settings_(other.volume_settings_), 
...
void PerlinModifierDecorator::modify(Matrix3D &mat, Vector &ray_direction, Vector &ray_position, Vector4 &src_rgba) {
...
PerlinModifierDecorator& PerlinModifierDecorator::operator= (
	PerlinModifierDecorator other) {
	swap(*this, other);
	return *this;
}

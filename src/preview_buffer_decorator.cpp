#include "preview_buffer_decorator.hpp"
...
PreviewBufferDecorator::PreviewBufferDecorator(const PreviewBufferDecorator &other)
...
PreviewBufferDecorator &PreviewBufferDecorator::operator=(PreviewBufferDecorator other) {
	swap(*this, other);
	return *this;
}

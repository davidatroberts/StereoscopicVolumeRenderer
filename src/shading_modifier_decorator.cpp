...
ShadingModifierDecorator::ShadingModifierDecorator(
	...
	illumination_ = IlluminationModelFactory::make_model(shader_settings_.illumination_model);

	// get the gradient function
	gradient_ = GradientFactory::make_gradient(shader_settings_.gradient, volume_settings_.resolution);
}

ShadingModifierDecorator::ShadingModifierDecorator(const ShadingModifierDecorator &other)
...
void ShadingModifierDecorator::modify(
	...
	Vector shade = illumination_(
		normal, ray_direction, light_direction, shader_settings_.ka, shader_settings_.kd, shader_settings_.ks,
		shader_settings_.n, shader_settings_.light_colour, shader_settings_.ambient_colour);
...
ShadingModifierDecorator &ShadingModifierDecorator::operator=(ShadingModifierDecorator other) {
	swap(*this, other);
	return *this;
}

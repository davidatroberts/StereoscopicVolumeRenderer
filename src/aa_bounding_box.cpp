...
AABoundingBox::AABoundingBox(Vector bboxmin, Vector bboxmax, Lattice *lattice)
	: bboxmin(bboxmin), bboxmax(bboxmax), lattice(lattice) {}

AABoundingBox::~AABoundingBox() {}

bool AABoundingBox::hit(Vector ray_origin, Vector ray_direction, Vector &ray_start, Vector &ray_end) {
	// r.dir is unit direction vector of ray
	Vector dir_frac(1.0f / ray_direction.x, 1.0f / ray_direction.y, 1.0f / ray_direction.z);
